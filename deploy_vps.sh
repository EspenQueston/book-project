...
if [ ! -f "$APP_DIR/.env" ]; then
    ...
    echo "  CSRF_TRUSTED_ORIGINS=https://duno360.com,https://www.duno360.com"
    echo ""
    echo "  See deploy/production.env.example for the full list of variables."
    echo ""
...
echo "  Site: https://duno360.com"
echo "  For automated setup on a fresh VPS, prefer: python deploy/deploy_new_vps.py"
echo "  (set env vars from deploy/.env.local.example first)"
echo "======================================================"

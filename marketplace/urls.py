...
urlpatterns = [
    ...
    path('products/<int:product_id>/presence/', views.product_presence, name='product_presence'),
    ...
    path('vendor/orders/update-status/', views.vendor_marketplace_order_update_status, name='vendor_marketplace_order_update_status'),
    path('vendor/products/', views.vendor_products, name='vendor_products'),
    path('vendor/products/add/', views.vendor_product_add, name='vendor_product_add'),
    path('publish/product/', views.vendor_publish_product, name='vendor_publish_product'),
    ...
    path('vendor/supermarket/', views.vendor_supermarket, name='vendor_supermarket'),
    path('vendor/supermarket/add/', views.vendor_supermarket_add, name='vendor_supermarket_add'),
